      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">E-Store</h3>
            <p className="text-gray-300 mb-4">
              Your trusted destination for quality products. We provide a secure, 
              user-friendly shopping experience with excellent customer service.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">123 Store St, City, Country</span>
              </div>
              <div className="flex items-center space-x-3">
